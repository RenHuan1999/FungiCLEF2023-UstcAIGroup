...
_C.dynamic_mlp = CN()
_C.dynamic_mlp.mlp_cin = 101
_C.dynamic_mlp.mlp_d = 256
_C.dynamic_mlp.mlp_h = 64
_C.dynamic_mlp.mlp_n = 2
_C.dynamic_mlp.mlp_type = 'c'
...
# -----------------------------------------------------------------------------
_C.TRAIN = CN()
_C.TRAIN.NEVER_MASK = False
_C.TRAIN.USE_ARCFACE = False
...
_C.TEST.CROP = True
_C.TEST.FIVE_CROP = False
_C.TEST.USE_GPS = True
